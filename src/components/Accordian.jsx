...
const Accordian = ({ title, answer }) => {
  ...
  return (
    <div className='p-6'>
        ...
        <div className={`grid overflow-hidden transition-all duration-300 ease-in-out text-slate-600 texxt-sm ${accordionOpen ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
